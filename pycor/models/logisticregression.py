...
dataset = pd.read_csv('../../data/feature2/feature_C-AA.tsv', '\t', encoding='utf8', header=0)
dataset = dataset.dropna()

# dataset = dataset[dataset['score']!=0]
dataset_2 = pd.read_csv('../../data/feature2/feature_A-B.tsv', '\t', encoding='utf8', header=0)
...
for classifier in classifiers:
    ...
    test.to_csv('../../var/log_proba_test_semi.tsv', sep='\t', encoding='utf8')
...
print()
print(zeros.loc[zeros['score']>=0.45])
print(ones.loc[ones['score']<0.1])
"""
# ones = train.loc[dataset['label']==1]
# zeros = train.loc[dataset['label']==0]

# zeros.loc[zeros['proba']<=0.4].to_csv('../../var/log_proba_main_fig_lab0.tsv', sep='\t', encoding='utf8')
# ones.loc[ones['proba']>=0.5].to_csv('../../var/log_proba_main_fig_lab1.tsv', sep='\t', encoding='utf8')
